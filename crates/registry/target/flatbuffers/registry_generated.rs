...
pub mod litehouse {
    ...
    impl<'b> flatbuffers::Push for Version {
        ...
        unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
            let src =
                ::core::slice::from_raw_parts(self as *const Version as *const u8, Self::size());
    ...
    impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> SummariesBuilder<'a, 'b, A> {
        ...
        pub fn add_summaries(
            ...
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(Summaries::VT_SUMMARIES, summaries);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
        ) -> SummariesBuilder<'a, 'b, A> {
    ...
    impl<'a> Summary<'a> {
        ...
        >(
            ...
            if let Some(x) = args.versions {
                builder.add_versions(x);
            }
        ...
        pub fn title(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<&str>>(Summary::VT_TITLE, None)
            }
        }
        #[inline]
        pub fn versions(&self) -> Option<flatbuffers::Vector<'a, Version>> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, Version>>>(
                        Summary::VT_VERSIONS,
                        None,
                    )
            }
        ...
        pub fn description(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<&str>>(Summary::VT_DESCRIPTION, None)
            }
        }
    }
    ...
    impl flatbuffers::Verifiable for Summary<'_> {
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                ...
                .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, Version>>>(
                    "versions",
                    Self::VT_VERSIONS,
                    false,
                )?
    ...
    impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> SummaryBuilder<'a, 'b, A> {
        ...
        pub fn add_title(&mut self, title: flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(Summary::VT_TITLE, title);
        }
        #[inline]
        pub fn add_versions(
            &mut self,
            versions: flatbuffers::WIPOffset<flatbuffers::Vector<'b, Version>>,
        ) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(Summary::VT_VERSIONS, versions);
        }
        #[inline]
    ...
    impl<'a> Entry<'a> {
        ...
        pub fn title(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<&str>>(Entry::VT_TITLE, None)
            }
        }
        #[inline]
        ...
        pub fn description(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<&str>>(Entry::VT_DESCRIPTION, None)
            }
        }
        #[inline]
        pub fn capabilities(
        ...
        pub fn schema(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<&str>>(Entry::VT_SCHEMA, None)
            }
        }
        #[inline]
        pub fn size_(&self) -> u32 {
        ...
        pub fn sha(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<&str>>(Entry::VT_SHA, None)
            }
        }
    }
    ...
    impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> EntryBuilder<'a, 'b, A> {
        ...
        pub fn add_title(&mut self, title: flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(Entry::VT_TITLE, title);
        }
        #[inline]
        pub fn add_version(&mut self, version: &Version) {
            self.fbb_
                .push_slot_always::<&Version>(Entry::VT_VERSION, version);
        }
        #[inline]
        pub fn add_description(&mut self, description: flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(Entry::VT_DESCRIPTION, description);
        }
        #[inline]
        ...
        pub fn add_schema(&mut self, schema: flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(Entry::VT_SCHEMA, schema);
        }
        #[inline]
        pub fn add_size_(&mut self, size_: u32) {
        ...
        pub fn add_sha(&mut self, sha: flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(Entry::VT_SHA, sha);
        }
        #[inline]
