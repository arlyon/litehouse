...
<OpenGraph href={`https://github.com/arlyon/litehouse/releases/tag/${latest_version ?? "v0.3.1"}`} />
...
<Tabs items={['Windows', 'Linux', 'macOS', 'Homebrew (coming soon)']}>
  ...
  <Tab value="Homebrew (coming soon)">
  ```
...
need a rust toolchain. Please visit [rustup.rs](https://rustup.rs) and follow
